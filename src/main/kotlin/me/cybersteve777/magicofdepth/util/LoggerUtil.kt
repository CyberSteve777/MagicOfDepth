package me.cybersteve777.magicofdepth.util
...
object LoggerUtil {
    ...
    fun getLogger(): Logger{
        val logger = Logger.getLogger(MagicOfDepth.MOD_ID)
    ...
    private class LogFormat: Formatter() {
        override fun format(record: LogRecord): String {
            ...
            val b = "[Magic of Depth/${record.level.localizedName}] [${record.sourceClassName}]: "
